        ...
        <div class="md:grid md:grid-cols-3 md:gap-6">
            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                <div class="shadow sm:rounded-md sm:overflow-hidden">
                    <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex items-center">
                                <img src="{{ $user->image }}"
                                     class="h-12 w-12 object-cover rounded-full ltr:mr-5 rtl:ml-5 border border-gray-300 mr-3">
                        
                                     {{-- <input type="file" class="w-full border border-gray-200 bg-gray-50 block focus:outline-none rounded-xl ml-3" name="image" id="file_input">
                                     <p class="mt-2 text-sm text-gray-500 dark:text-gray-300" id="file_input_help">PNG, JPG or GIF</p> --}}

                                     <input class="w-full border border-gray-200 bg-gray-50 block focus:outline-none rounded-xl hidden ml-3" name="image" id="file_input" type="file">
                    ...
                    <div class="px-4 py-5 bg-gray-50 text-right sm:px-6 my-3">
                        <x-button>{{ __('Save') }}</x-button>
                        {{-- <x-primary-button class="mt-4 md-3">{{__('Save')}}</x-primary-button> --}}
                    </div>
                </div>
            </div>
        </div>
